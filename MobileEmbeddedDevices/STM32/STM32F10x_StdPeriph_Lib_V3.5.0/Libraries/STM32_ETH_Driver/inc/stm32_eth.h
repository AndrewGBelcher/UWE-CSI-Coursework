...
// for KS8721 craig 
#define PHY_SR                           1      /* Tranceiver Status Register Craig for Micrel KS8721 */
/* PHY status register */
#define PHY_Speed_Status            ((u16)0x0000)    /*!< Configured information of Speed: 100-Mbps */
#define PHY_Duplex_Status           ((u16)0x0004)    /* Configured information of Duplex: Full-duplex */
#define PHY_ANLPAR_FULLDUPLEX_100M  ((u16)0x100)  /* Configured information of Speed: 100Mbps Changed by Craig */
#define PHY_ANLPAR		    (0x5)	/*PHY auto negotiate Link Patner Ability Reg */
